...
module.exports = (platform, options) => {
  ...
  serveOptions.sassCompile = (options.nosass) ? false : options.sass || true;
  serveOptions.pcssCompile = (options.nosass) ? false : options.pcss || true;
  ...
  serveOptions.defaultCssvars = options.cssvars || false;
