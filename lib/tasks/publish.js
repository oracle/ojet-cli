...
module.exports = function (task, scope, parameters, options) {
  ...
  if (utils.isWebpackApp()) {
    utils.log.error('Publishing components or packs is not supported in a Webpack-managed project. Switch to a non-Webpack projects to publish components and packs.');
